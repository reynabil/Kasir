                            ...
                            <div class="card-body">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        <p class="fs-14 mb-2">Total Produk</p>
                                        <span class="title text-black font-w600">{{ $produk }}</span>
                                    </div>
                                </div>
                        ...
                        <div class="card avtivity-card">
                            <div class="card-body">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        <p class="fs-14 mb-2">Total Penjualan</p>
                                        <span class="title text-black font-w600">{{ $penjualan }}</span>
                                    </div>
                                </div>
                                <div class="progress" style="height:5px;">
